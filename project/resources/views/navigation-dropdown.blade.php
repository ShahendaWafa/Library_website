        ...
        <div class="flex justify-between h-16" >
            <div class="flex" >
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="/dashboard">
                    <img src = "css/logo.png" width="50" height="60">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/allbooks" :active="request()->routeIs('allbooks')">
                        {{ __('All Books') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/borrowedbooks" :active="request()->routeIs('borrowedbooks')">
                        {{ __('Borrowed Books') }}
                    </x-jet-nav-link>
                </div>
                @if(Auth::user()->id == 1)
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/allusers" :active="request()->routeIs('allusers')">
                        {{ __('All Users') }}
                    </x-jet-nav-link>
                </div>
                @endif
